...
<div style="padding-top: 50px">
               <h1>
                <b style="padding-left: 80px"> Welcome Manager! </b>
                  ...
                  <div class="row" style="padding-left: 60px">
                   ...
                   <div class="column">
                        ...
                        <div class="column">
                            ...
                            <div class="widget-title">
          <button class="btn btn-primary" data-toggle="modal" data-target="#article"> <b>Add </br>Hospital</br>News  </b></button>
                            </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h1 class="modal-title">Add Hospital News</h1>
                            </div>
