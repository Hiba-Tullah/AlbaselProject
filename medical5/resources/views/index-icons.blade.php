...
<head>
    ...
    <!-- Title  -->
    <title>Albasel Hospital Portal - Health &amp; Medical | About Us</title>
                    ...
                    <div class="col-12 h-100">
                        <div class="h-100 d-md-flex justify-content-between align-items-center">
                           <p>Welcome to <span>Albasel Hospital Portal</span> 
                            <p>Opening Hours : Sunday to Thusrday - 8am to 3pm Contact : <span>+96341374711</span></p>
                        </div>
                    </div>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This website is made  <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Eng Hiba Tullah Mahmoud</a>
